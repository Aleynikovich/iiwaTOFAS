...
import application.RoboDKDriver.SubPrograms;
...
//import com.kuka.generated.ioAccess.WagoIOIOGroup;
import com.kuka.roboticsAPI.applicationModel.RoboticsAPIApplication;
import static com.kuka.roboticsAPI.motionModel.BasicMotions.*;
 ...
 * @see #dispose()
 */
public class RoboDK extends RoboticsAPIApplication {
...
//	@Inject protected WagoIOIOGroup wagoIOIOGroup;
    ...
    public void run() {
        ...
        double speed_mms = 100;
        double speed_degs = 50;
        double accel_mmss = 50;
        double accel_degss = 50;
        ...
        */
        ...
        while (keepAlive){
            try {
                ...
                sendLine("Hello from KUKA IIWA robot");
                ...
                while (keep_connected){
                    ...
                    switch (cmd){
                        ...
                        case MSG_SETDO:{
                            ...
                            switch (doId) {
                                //case 0: robotIOs.setLEDRed(doValue); break;
                                //case 1: robotIOs.setLEDGreen(doValue); break;
                                case 2: robotIOs.setLEDBlue(doValue); break;
//                                case 3: wagoIOIOGroup.setSuckerOn(doValue); break;
//                               case 4: wagoIOIOGroup.setBlowOff(doValue); break;
                            }
                            sendInt(MSG_ACKNOWLEDGE);
                            break;
                        }
