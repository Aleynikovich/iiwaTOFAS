...
public enum MovementType {
    ...
    public static MovementType fromActionType(ActionTypes actionType) {
        switch (actionType) {
            case PTP_AXIS: return PTP_AXIS;
            case PTP_FRAME: return PTP_FRAME;
            case LIN_AXIS: return LIN_AXIS;
            case LIN_FRAME: return LIN_FRAME;
            case CIRC_AXIS: return CIRC_AXIS;
            case CIRC_FRAME: return CIRC_FRAME;
            case PTP_AXIS_C: return PTP_AXIS_C;
            case PTP_FRAME_C: return PTP_FRAME_C;
            case LIN_FRAME_C: return LIN_FRAME_C;
            case LIN_REL_TOOL: return LIN_REL_TOOL;
            case LIN_REL_BASE: return LIN_REL_BASE;
