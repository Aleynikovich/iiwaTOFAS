...
public class IOFlangeIOGroup extends AbstractIOGroup
{
     ...
     *
     * @param controller the controller, which has access to the I/O group 'IOFlange'
     */
    @Inject
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange1'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange2'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange3'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange4'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange5'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange6'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange7'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DO_Flange8'
     */
