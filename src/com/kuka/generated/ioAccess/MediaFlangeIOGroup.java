...
public class MediaFlangeIOGroup extends AbstractIOGroup
{
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'LEDBlue'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'SwitchOffX3Voltage'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'OutputX3Pin1'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'OutputX3Pin2'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'OutputX3Pin11'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'OutputX3Pin12'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'LedRed'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'LedGreen'
     */
