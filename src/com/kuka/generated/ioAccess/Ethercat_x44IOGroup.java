...
public class Ethercat_x44IOGroup extends AbstractIOGroup
{
     ...
     *
     * @param controller the controller, which has access to the I/O group 'Ethercat_x44'
     */
    @Inject
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output1'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output2'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output3'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output4'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output5'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output6'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output7'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'Output8'
     */
